//+------------------------------------------------------------------+
//|                                Ultra_Monster_MT5_v8.mq5        |
//|   🔥 ULTRA MONSTER Engine v8 — 9-Pair Rolling ORB (75%+ WR)    |
//+------------------------------------------------------------------+
...
int OnInit() {
   Print("=== 🔥 ULTRA MONSTER Engine MT5 Init v8 (9-Pair Rolling ORB) ===");
...
bool OpenTrade(int idx, string side, double lot) {
   ...
   req.magic = MAGIC_BASE + idx; req.comment = "UltraMonster_v8";
