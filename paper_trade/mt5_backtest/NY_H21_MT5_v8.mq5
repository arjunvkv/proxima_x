//+------------------------------------------------------------------+
//|                                NY_H21_MT5_v8.mq5               |
//|   🔥 NY H21 Engine v8 — 21:00 UTC Closing Bell Mean Reversion  |
//|   v8: Magic Base 202670 (Zero Collision), SL=50p/TP=80p Guard  |
//+------------------------------------------------------------------+
...
input double   BASE_LOT            = 1.50;    // Base Lot Size
...
int OnInit() {
   Print("=== NY H21 Engine MT5 Init v8 (21:00 UTC Close Reversion) MagicBase=", MAGIC_BASE, " ===");
...
bool OpenTrade(int idx, string side, double lot) {
   ...
   req.magic = MAGIC_BASE + idx; req.comment = "NY_H21_v8";
