...
#property description "V2z Pro - Winning config z=4.0 stop=6 trail=1 lot=0.75"

input double   Z_THRESHOLD      = 4.0;
input double   STOP_A           = 6.0;
...
int OnInit() {
   ...
   ClearPosition();
   Print("V2z_CPPF on ", _Symbol, " magic=", MAGIC_NUMBER,
         " slippage=", SLIPPAGE_PIPS, "pip comm=", COMMISSION_PER_LOT, "$/lot");
