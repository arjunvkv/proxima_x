//+------------------------------------------------------------------+
//|                                CPMC_Z_MT5_v107.mq5               |
//|   🔥 CPMC Z Engine v107 — Cross-Pair Momentum Expansion (61%+ WR) |
//|   v107: Magic Base 202690 (Zero Collision), SL=50p/TP=80p Guard  |
//+------------------------------------------------------------------+
...
int OnInit() {
   Print("=== CPMC Z Engine MT5 Init v107 (Cross-Pair Momentum) MagicBase=", MAGIC_BASE, " ===");
...
bool OpenTrade(int idx, string side, double lot) {
   ...
   req.magic = MAGIC_BASE + idx; req.comment = "CPMC_Z_v107";
