...
#property description "V2z CPPF GAPFIX - RECON + spread-relative min_gap"
...
input double   SPREAD_MULTIPLE   = 2.0;
...
void ManagePosition() {
   ...
   double spread_val = GetSpreadPips() * _Point;
   double min_gap = spread_val * SPREAD_MULTIPLE;
