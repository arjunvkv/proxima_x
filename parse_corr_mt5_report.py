#!/usr/bin/env python3
"""Parse MT5 Strategy Tester Report for #8 Correlation Breakdown."""
import re, glob
from bs4 import BeautifulSoup

def main():
    report_files = glob.glob(r'C:\Users\Arjun Sasi\AppData\Roaming\MetaQuotes\**\corr_breakdown_report*.htm*', recursive=True)
    if not report_files:
    ...
    print("="*85)
    print("OFFICIAL MT5 STRATEGY TESTER REPORT: #8 CORRELATION BREAKDOWN (LAGGARD CATCH-UP)")
    print("Server: FundedNext Server 3 | Symbol: NZDUSD | Model: Real Ticks")
    print("="*85)
