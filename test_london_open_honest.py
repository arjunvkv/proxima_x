#!/usr/bin/env python3
"""London Open (07:00 UTC / 08:00 UTC) Fade — 5-Broker Honest Backtest."""
import sys, time
...
def main():
    t0 = time.time()
    print("Loading M5 dataset for London Open 07:00 UTC Audit...")
    ...
    print("\n" + "="*85)
    print("LONDON OPEN (07:00 UTC / 12:30 PM IST) — 5-BROKER TRANSACTION AUDIT")
    print("="*85)
    ...
    for b in BROKERS:
        ...
        for t in range(25, n_bars):
            ...
            # Trigger condition: 07:00 UTC London Open
            # 1-hour Asian range drive from 06:00 to 07:00 UTC (12 M5 bars)
