"""Stub-gated re-export for the missing real module (meta_reweighter).

The original meta_reweighter was proven to have never been in git history (74 commits,
...
if _gate.REALITY_ENABLED:
    raise ImportError(
        "proxima_ops.reality.meta_reweighter is not rebuilt yet but "
        "PROXIMA_REALITY_ENABLED=1. Either rebuild it or unset the flag. "
        "Refusing to silently run a no-op stub in production.")

from proxima_ops.reality._stubs import AdaptiveMetaReweighter  # noqa: F401, E402
