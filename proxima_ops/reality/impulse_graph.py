"""Stub-gated re-export for the missing real module (impulse_graph).

The original impulse_graph was proven to have never been in git history (74 commits,
...
if _gate.REALITY_ENABLED:
    raise ImportError(
        "proxima_ops.reality.impulse_graph is not rebuilt yet but "
        "PROXIMA_REALITY_ENABLED=1. Either rebuild it or unset the flag. "
        "Refusing to silently run a no-op stub in production.")

from proxima_ops.reality._stubs import ImpulseGraph  # noqa: F401, E402
