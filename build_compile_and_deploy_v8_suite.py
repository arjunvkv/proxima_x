...
V8_CONFIGS = [
    {
        "target": "TokyoH0_MT5_v8",
        "source": "TokyoH0_MT5_v107.mq5",
        "lot": "1.00",
        "magic": "202630"
    },
    {
        "target": "Ultra_Monster_MT5_v8",
        "source": "Ultra_Monster_MT5_v107.mq5",
        "lot": "1.20",
        "magic": "202600"
    },
    {
        "target": "CPPF_Z_MT5_v8",
        "source": "CPPF_Z_MT5_v107.mq5",
        "lot": "1.40",
        "magic": "202650"
    },
    {
        "target": "MSV_Asian_Exhaustion_MT5_v8",
        "source": "MSV_Asian_Exhaustion_MT5_v107.mq5",
        "lot": "1.00",
        "magic": "202640"
    },
    {
        "target": "NY_H21_MT5_v8",
        "source": "NY_H21_MT5_v107.mq5",
        "lot": "1.50",
        "magic": "202660"
    },
    {
        "target": "CPMC_Z_MT5_v8",
        "source": "CPMC_Z_MT5_v107.mq5",
        "lot": "1.40",
        "magic": "202670"
    },
]
...
def main():
    print("=" * 115)
    print("PROXIMA X — BUILDING, COMPILING & DEPLOYING NEW PROVEN v8 STRATEGY SUITE TO VPS...")
    print("=" * 115)
    ...
    for cfg in V8_CONFIGS:
        ...
        # Replace lot size with requested lot size
        import re
