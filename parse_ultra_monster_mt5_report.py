#!/usr/bin/env python3
"""Parse MT5 Strategy Tester Report for ULTRA MONSTER Engine."""
import re, glob
from bs4 import BeautifulSoup

def main():
    report_files = glob.glob(r'C:\Users\Arjun Sasi\AppData\Roaming\MetaQuotes\**\ultra_monster_report*.htm*', recursive=True)
    if not report_files:
    ...
    print("="*85)
    print("OFFICIAL MT5 STRATEGY TESTER REPORT: 🔥 ULTRA MONSTER ENGINE")
