#!/usr/bin/env python3
"""Long-Term Statistical Audit for Rolling Hourly ORB."""
import sys, time
...
from test_rolling_orb_seasonality_honest import run_rolling_hourly_orb, load_and_align
...
def main():
    ...
    df_t = run_rolling_hourly_orb(df_all, close_mat, open_mat, high_mat, low_mat, hours, minutes)
    ...
    print("="*85)
    print("STATISTICAL AUDIT RESULTS: ROLLING HOURLY ORB")
    print("="*85)
