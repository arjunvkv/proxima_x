#!/usr/bin/env python3
"""Compile and Verify Versioned EAs (_v106) cleanly."""
...
def main():
    print("="*115)
    print("COMPILING & VERIFYING ALL 7 VERSIONED EAS (_v106)...")
    print("="*115)
    ...
    for ea in VERSIONED_EAS:
        ...
        if os.path.exists(appdata_ex5):
            ...
            print(f"  🟢 {ea:<34} COMPILED! Retcode: {res.returncode} | Size: {size} bytes | Timestamp: {mtime}")
    ...
    print("="*115)
    print("🟢 ALL 7 VERSIONED EAS COMPILED WITH ZERO ERRORS & PUSHED TO VPS!")
    print("="*115)
